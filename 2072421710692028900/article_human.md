...
- <strong>美团造出万亿参数大模型</strong>：美团LongCat Lab（原"光年之外"团队）发布了LongCat 2.0，一个1.6T参数的模型，完全在华为国产910C芯片上训练，Terminal Bench 2达到70.8%<br><br>
...
LongCat Lab的出现也值得深思。当一家美团都开始训练1.6T参数的模型，说明AI竞争已经从"技术赛道"变成了"生存赛道"：不上船，就会出局。下一个"意想不到的选手"会是谁？高德？货拉拉？还是携程？<br><br>
...
<a class="normal_text_link mp_article_text_link" href="https://mp.weixin.qq.com/s/qcIFzXsBalSGpca5fzJKxg" target="_blank" data-linktype="2">Claude Code动态Workflow Vs. SubAgent Vs. Skill</a></span>
