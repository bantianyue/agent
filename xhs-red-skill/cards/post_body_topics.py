"""Post with #topic in body text only - no hash_tag API field."""
import json
import sys
import os
...
def main():
    ...
    # Post with #topic in body text - this is how XHS native app does it
...
#REDSkill #VibeCoding #AI工具 #小红书 #效率工具"""
    
    result = client.create_image_note(
        title=title,
        desc=desc,
        image_file_ids=file_ids,
        topics=[],  # Empty - let body text handle topics
        is_private=False,
    )
