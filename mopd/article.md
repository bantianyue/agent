...
![](img1.png)
<span style="font-size:12px;color:rgb(153,153,153);">MOPD三阶段示意图：从SFT起点出发，各领域独立RL训练教师，再通过蒸馏集成到同一学生模型。</span>
...
![](img3.png)
<span style="font-size:12px;color:rgb(153,153,153);">MiMo-V2-Flash 309B模型在7个基准上的对比结果，MOPD在5个上超越教师。</span>
...
![](img4.png)
<span style="font-size:12px;color:rgb(153,153,153);">不同来源教师的分布差距对比（左：同源教师KL仅0.04，右：235B大模型KL高达0.19）。</span>
...
![](img5.png)
<span style="font-size:12px;color:rgb(153,153,153);">多轮MOPD迭代的效果：第二轮蒸馏归一化得分从0.937提升到0.986。</span>
