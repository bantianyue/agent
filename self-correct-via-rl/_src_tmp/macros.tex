...
\newcommand{\fb}[1]{{\textcolor{magenta}{[FB: #1]}}}
\newcommand{\as}[1]{{\textcolor{blue}{#1}}}
\newcommand{\aviral}[1]{{\textcolor{red}{[AK: #1]}}}
\newcommand{\sandra}[1]{{\textcolor{purple}{#1}}}
...
\newcommand{\icdelta}{\Delta^{\mathrm{i} \rightarrow \mathrm{c}}}
\newcommand{\cidelta}{\Delta^{\mathrm{c} \rightarrow \mathrm{i}}}
...
\newcommand{\methodname}{{\textbf{\emph{SCoRe}}}}
\newcommand{\pairsft}{Pair-SFT}
...
\newcommand{\posdata}{\mathcal{D}^+_\text{syn}}
\newcommand{\negdata}{\mathcal{D}^-_\text{syn}}
