...
他把自己的转变讲得很直白：以前是孤军奋战，靠Grok、Claude、Gemini做高层搜索，再配合一堆小众工具做深度检索；**现在变成了「调用对的技能或工具，等Hermes跑完研究，再去交叉核对它的产出」**。磨合那条研究流水线花了点时间，因为要覆盖的资产和策略实在太宽，但跑顺之后，最值钱的就是下面这几条。

## 1. 每日Alpha流水线：追踪 + 书签 + 综合

X上从不缺alpha，但现在的算法让你几乎刷不到关注的大V，想全面掌握动态基本不可能。**Hermes在这里干的是「信息雷达 + 编辑部」的活。**
...
最后一步是把分析师输出、书签和轮换外部来源一起，喂进一个「Top 10 alpha综合」定时任务。**于是他不用逐条读摘要，先扫Top 10，再对感兴趣的头条深挖。** Top 10里的全部内容会写进Hindsight外部记忆，这些学到的东西又用来优化第二天的上下文。
