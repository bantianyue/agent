...
> **Source:** Baseten Blog — Mahmoud Hassan
> **Published:** June 25, 2026
> **Original URL:** https://www.baseten.co/blog/live-draft-model-training-for-speculative-decoding/
> **X Post:** https://x.com/rachelrapp/status/2070493769690910913

---

Draft models, such as [EAGLE-3](https://arxiv.org/abs/2501.00514) and [DFlash](https://arxiv.org/abs/2502.05810), have become a widely adopted technique for accelerating large language model (LLM) inference, leading to 2-3x higher throughput and lower latency. However, keeping these draft models aligned with diverse base models and dynamic traffic patterns remains a significant engineering challenge.
...
1. **Storage overhead:** Saving hidden states for offline training is infeasible at production volumes. A single sample on Kimi K2 can exceed 2GB, and full draft training requires millions of them.
...
![Inference and training nodes run in parallel across a distributed cluster.](https://www.datocms-assets.com/104802/1782399206-speculator-diagram_kb-update_62426-1.png?auto=format&w=1200)
...
If you want to leverage live draft model training for your inference workloads, reach out to talk to our engineers.
