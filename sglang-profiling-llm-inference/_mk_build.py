...
DATA = {
    ...
    "sections": [
        ...
        # ============ 节4: 模式1 - 重复的峰值 ============
        {
            ...
            "paras": [
                "________________PLACEHOLDER0________________",
                ...
                "________________PLACEHOLDER1________________",
                "为什么认为第一组中的第一个峰值远大于其他峰值？假设是第一个混合块相比其他块通常有一些额外的设置开销。",
                "接着滚动到接下来的两个峰值，以及第一组内较小的峰值。",
                "________________PLACEHOLDER2________________",
                ...
                "________________PLACEHOLDER3________________",
        ...
        # ============ 节7: 解码阶段 ============
        {
            ...
            "paras": [
                ...
                "________________PLACEHOLDER4________________",
            ],
            "fig_after": {
