...
1965 年，Richard Feynman 获得了诺贝尔物理学奖。但他最被人记住的，不是物理学——而是他在 Caltech 使用的一套 4 步学习方法。简单到 12 岁孩子都能操作，MIT、Stanford 和 UCLA 在他去世 38 年后仍在教授。
...
这就是**遗忘曲线**。它适用于书籍、课程、讲座、在线文章等各类学习。没有主动强化，你读的大部分内容在一个月内就会消失。

更深层的原因是：认知科学家称之为**流利错觉（fluency illusion）**。阅读的轻松感被误认为是真正的理解。一段清晰的文字感觉像知识，但其实不是，那是识别。你只是看到了这个想法，并没有使用它。
...
**Protégé 效应。** Koh、Lee 和 Lim（2018）发现，向他人教授材料的学生比只学习的学生得分高 **10% 到 20%**。教授行为迫使提取，这才是构建记忆的关键。Prompt 1 和 4 激活了这个效应。

**提取练习。** Karpicke 和 Blunt（2011）发表在《Science》上的研究表明，从大脑中提取信息比输入信息效果显著更好。自我测试在每一项指标上都击败了重读。Prompt 2 和 3 强制提取。

**理想难度。** Robert Bjork（1994）在 UCLA 提出了这个术语。感觉轻松的学习是浅层的。感觉困难的学习才是深层的。**你在打字写出自己解释时感受到的不适不是失败，而是你的大脑在建立更强连接的瞬间。**
...
大多数人读完一本书后只留下模糊的「好书」感觉。用了这个 Prompt 后，你走开时能列出 5 个有名字的概念。**这就是感觉和记忆的区别。**
...
**这就是全部的关键。你打出自己版本的那一刻，才是学习真正发生的时刻。** 读书、划重点、做笔记都不如用自己简单的话写出来。
...
这是书籍给不了你的步骤。一本书不知道你错过了什么。Claude 知道，它读了你的解释，能看出逻辑在哪里断了。

作者在物理、金融、AI 甚至谈判策略上都用过这个。**每次 Claude 都发现至少 2 个我以为懂了但实际上没懂的概念。**
...
「类比在哪里失效」这部分是这个 Prompt 与众不同的地方。大多数老师给出类比就停了。Feynman 坚持展示局限性。**这能避免你把错误的心理模型带入下一次对话。**
...
**总时间：每个主题 20 分钟。四轮主动提取。比大多数在线课程学到的东西还多。**
...
我们正处于一个 <strong>18 个月的窗口期</strong>。学会用 AI 做主动回忆的人，将远远超越用 AI 做摘要的人。他们在打出自己的版本，而其他人还在划重点。18 个月后，这种工作流会成为每个阅读应用的默认功能。优势将消失。今天它还是一个安静的技巧。<br><br>
