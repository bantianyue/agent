...
**前沿实验室把环境这一块当作专有资产严密保护，这就是为什么很少有从业者见过一个真正的环境从内部是什么样子。** 免费提供环境的团队叫Prime Intellect，他们的库叫Verifiers，就是我们要用的框架，100% 开源。设计与模型无关（model-agnostic），奖励完全可验证，同一套骨架适用于你想训练的任何回合制任务。
