DATA = {
    "title": "xHC：把残差流扩展变成真正可用的 Scaling 维度",
    "summary": [
        {"key": "突破 N=4 天花板", "body": "xHC 是首个在超连接（HC）家族中将残差流扩展到 N=4 之外仍有效且经济的方法，主设置 N=16、仅激活 k=4 条流（即 16 条流里只有 4 条真正参与残差混合）。"},
    ...
    "conclusion": [
        ...
        "回看全文，最值得记住的一点是：残差流扩展这条轴此前被低估，不是因为它没用，而是因为旧方法（mHC）在 N=4 之后同时撞上「信息喂不饱」和「成本涨太快」两面墙。xHC 的价值在于证明这两面墙都可以被拆掉，而非绕开。",
    ],
