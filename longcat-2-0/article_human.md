...
Benchmark 柱状图直观展示了 LongCat-2.0 在 6 个主要基准上与竞品的对比：

![](img1.png)
<span style="font-size:12px;color:rgb(153,153,153);">LongCat-2.0 vs 竞品在 Terminal-Bench、SWE-bench Pro、SWE-bench Multilingual、FORTE、RWSearch、BrowseComp 上的对比。</span>

评测细节数据如下：

![](evalueates.png)
<span style="font-size:12px;color:rgb(153,153,153);">LongCat-2.0 vs Gemini 3.1 Pro / GPT-5.5 / Claude Opus 系列完整评测对比表。</span>
