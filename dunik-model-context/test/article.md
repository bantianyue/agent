...
![Agent loop detail](agent-loop-detail.png)

---

## Loop 2 — The Verification loop

![Verification loop diagram](loop2.png)
...
![Verification loop detail](verification-loop-detail.png)

---

## Loop 3 — The Event-driven loop

![Event-driven loop diagram](event-loop.png)
...
![Event-driven loop detail](event-loop-detail.png)

---

## Loop 4 — The Hill-climbing loop

![Hill-climbing loop diagram](hill-climbing-loop.png)
...
![Hill-climbing loop detail](hill-climbing-loop-detail.png)
...
*Source: [dunik (@dunik_7) on X](https://x.com/dunik_7/status/2069079047510864322)*
*Diagrams from: [LangChain — The Art of Loop Engineering](https://www.langchain.com/blog/the-art-of-loop-engineering)*
