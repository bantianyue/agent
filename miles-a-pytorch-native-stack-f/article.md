...
![](img1_sglang.jpg)
<span style="font-size:12px;color:rgb(153,153,153);">Miles架构概览：SGLang、Megatron-LM、Ray、PyTorch四大组件的组合关系</span>
...
![](img2_megatron.jpg)
<span style="font-size:12px;color:rgb(153,153,153);">Megatron-LM训练后端的分布式训练结构</span>
