# article_data_build.py — 定义 DATA 供 write-article-data.py 序列化
...
DATA = {
  ...
  "summary": [
    ...
    {"key": "扁平 KV 缓存", "body": "单一分页池配异构视图，统一分配单元却不强制统一页大小，省显存不碎片。"},
    {"key": "统一 kernel API", "body": "一套 API 横跨 NVIDIA/AMD，复用模型逻辑，只在关键处做专门优化。"},
    {"key": "MTP 提速 2.3×", "body": "B200 上 MTP(8 draft steps) 达 354.6 tok/s/用户，比关 MTP 提升 2.33×。"},
  ],
  "lead": [
  ...
  "sections": [
    ...
    {"type": "h2", "title": "原生 FP4 量化的模型", "paras": [
    ...
    {"type": "h2", "title": "借助原生 Kernel 加速推理", "paras": [
    ...
    {"type": "h2", "title": "面向异构状态的扁平缓存布局", "paras": [
    ...
    {"type": "h2", "title": "面向 NVIDIA GPU 的 CuteDSL 注意力", "paras": [
    ...
    {"type": "h2", "title": "面向 AMD GPU 的 Gluon 注意力", "paras": [
